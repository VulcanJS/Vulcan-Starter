...
- How to [register](https://docs.vulcanjs.org/components.html#Registering-Components) and [use](https://docs.vulcanjs.org/components.html#Using-Components) components.
